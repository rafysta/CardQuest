...
(function (global) {
  ...
  const LORE = {
    ...
    areas: {
      ...
      mountain: {
        first: [
          { face: 'calm', lines: ['山地だ。道は細く、風が強い。', '魂は岩陰に張り付いている。'] },
          { face: 'calm', lines: ['ここの記録者は盗人あがりだ。', 'だが、書いたものは盗られん。'] }
        ],
        depart: [
          { face: 'calm', lines: ['風に逆らうな。行け。'] }
        ],
        repeat: [
          [{ face: 'calm', lines: ['山地だ。今日は風が弱い。'] }],
          [{ face: 'calm', lines: ['岩が乾いている。足を滑らせるな。'] }],
          [{ face: 'down', lines: ['山地だ。……昔は、ここを越えて通った。'] }]
        ],
        masterIntro: [
          { face: 'calm', lines: ['最奥にいるのは女の記録者だ。', '盗人あがりで、手が早い。'] }
        ],
        fog: [
          { face: 'calm', lines: ['霧だ。山では下から湧いてくる。', '足元を確かめて歩け。'] }
        ]
      },
      coast: {
        first: [
          { face: 'calm', lines: ['海辺だ。ここで島の道は終わる。', '渡れなかった魂が、いちばん多い。'] },
          { face: 'calm', lines: ['波の音に紛れて近づく者がいる。', '数を数えてから踏み込め。'] }
        ],
        depart: [
          { face: 'calm', lines: ['潮が満ちる前に戻れ。'] }
        ],
        repeat: [
          [{ face: 'calm', lines: ['海辺だ。今日は波が高い。'] }],
          [{ face: 'calm', lines: ['潮が引いている。歩ける岩が増えるな。'] }],
          [{ face: 'down', lines: ['海辺だ。……水際は、どうも得意でない。'] }]
        ],
        masterIntro: [
          { face: 'calm', lines: ['最奥は傭兵あがりの記録者だ。', '金で戦い、金で退く男だった。'] }
        ],
        fog: [
          { face: 'calm', lines: ['海霧だ。音のほうが先に届く。', '見えるものより、聞こえるものを信じろ。'] }
        ]
      },
      desert: {
        first: [
          { face: 'calm', lines: ['砂漠だ。ここには何も残らん。', '骨も、名も、砂が均していく。'] },
          { face: 'calm', lines: ['先は荒野に続いている。', '大物が一体だけ紛れることがある。'] }
        ],
        depart: [
          { face: 'calm', lines: ['日が落ちる前に戻れ。'] }
        ],
        repeat: [
          [{ face: 'calm', lines: ['砂漠だ。日が高いうちに済ませろ。'] }],
          [{ face: 'calm', lines: ['風紋が変わっている。昨日の道は無い。'] }],
          [{ face: 'down', lines: ['砂漠だ。……ここを歩いた覚えがある。'] }]
        ],
        masterIntro: [
          { face: 'calm', lines: ['最奥にいるのは吟遊詩人だ。', '歌うために島に残った変わり者だ。'] }
        ],
        fog: [
          { face: 'calm', lines: ['砂嵐だ。目を開けていても見えん。', '近づくまで、相手は分からんぞ。'] }
        ]
      }
    },
