 ...
 * 効果がまだ実装されていない魔法（M4 v0.13〜）は入れず、
 * 能力値に効く技能と、フラグ型の魔法（爆殺・障壁・遮蔽・偽装・鏡身）を中心にしている。
 * v0.12（実装計画M4）で発動処理を追加した 167/169/181/184/186/199 も混ぜてある。 */
const SAMPLE_DECK = [
  ...
  /* 技能20枚 */
  151, 152, 157, 158, 165, 167, 169, 171, 172, 173, 177, 178, 179, 181, 183, 184, 186, 192, 193, 199,
  /* 魔法5枚（表になっている間ずっと効くタイプ） */
  104, 117, 136, 143, 145
];
